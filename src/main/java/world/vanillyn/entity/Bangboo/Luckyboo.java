...
public class Luckyboo extends Bangboo {
    public Luckyboo(EntityType<? extends PathAwareEntity> entityType, World world) {
    ...
    public Identifier getCustomTexture() {
        return Meow.id("textures/entity/bangboo/luckyboo/luckyboo.png");
    }
}
